...
Router - controller - jbuilder - back to front end
...
4. jbuilder role (https://github.com/rails/jbuilder)
Jbuilder gives you a simple DSL (domain specific language) for declaring JSON structures that beats manipulating giant hash structures. This is particularly helpful when the generation process is fraught with conditionals and loops. Here's a simple example:
